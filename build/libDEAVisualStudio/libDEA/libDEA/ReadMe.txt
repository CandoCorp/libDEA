========================================================================
    BIBLIOTECA ESTÁTICA: libDEA Información general del proyecto
========================================================================

libDEA es una libreria para estructura de datos y algoritmos

AppWizard ha creado este proyecto de biblioteca libDEA.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación libDEA.
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado libDEA.pch y un archivo de tipos precompilados llamado StdAfx.obj.
